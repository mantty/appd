...
use target_pack_format::{
    Artifact, ArtifactKind, Platform, Target, TargetPackError, TargetPackManifest,
    TargetPackVersion, load_manifest, write_manifest,
};
...
const TARGET_METADATA: &[TargetMetadata] = &[
    ...
    (
        ...
        "windows",
        "target-pack.ps1",
        "bin/appd-shell-windows.exe",
        "runtime/appd-shell-windows.exe",
        false,
