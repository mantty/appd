...
pub(super) fn stat_object<'js>(
    ...
    let object = Object::new_proto(ctx.clone(), prototype.as_ref())?;
    let is_file = stat.kind == crate::vfs::NodeType::File && !stat.device;
    let is_directory = stat.kind == crate::vfs::NodeType::Directory;
...
const fn node_type_name(kind: crate::vfs::NodeType) -> &'static str {
    match kind {
        crate::vfs::NodeType::File => "file",
        crate::vfs::NodeType::Directory => "directory",
        crate::vfs::NodeType::Symlink => "symlink",
    }
}
...
pub(super) fn set_type_methods<'js>(
    ctx: &Ctx<'js>,
    object: &Object<'js>,
    kind: crate::vfs::NodeType,
    device: bool,
) -> rquickjs::Result<()> {
    let is_file = kind == crate::vfs::NodeType::File && !device;
    let is_directory = kind == crate::vfs::NodeType::Directory;
    let is_symlink = kind == crate::vfs::NodeType::Symlink;
