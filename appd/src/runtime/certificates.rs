...
use super::certificate::{CertificateBundle, CertificatePaths};
...
impl Certificates {
    ...
    pub fn trusts_server_certificate(&self, host: &str, certificate: &str) -> bool {
        ...
        super::certificate::certificate_der(certificate)
            == super::certificate::certificate_der(&current.server_cert_pem)
    }
}
